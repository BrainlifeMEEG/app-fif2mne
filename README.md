...
This Brainlife App converts MEG `fif` files to MNE raw data, using `mne.io.read_raw_fif` function from MNE-python.
...
*MNE-Python package:*  
Gramfort A, Luessi M, Larson E, Engemann DA, Strohmeier D, Brodbeck C, Goj R, Jas M, Brooks T, Parkkonen L, and Hämäläinen MS.  **MEG and EEG data analysis with MNE-Python**. Front. in Neurosci., 7(267):1–13, 2013. [https://doi.org/10.3389/fnins.2013.00267](https://doi.org/10.3389/fnins.2013.00267)
